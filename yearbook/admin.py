...
class StudentAdmin(UserAdmin):
    ...
    ordering = ('student_id',)  # Updated to order by student_id

    # Define the fieldsets to display in the admin
    fieldsets = (
    ...
    # Add the AnswerInline to display related answers
...
class AnswerAdmin(admin.ModelAdmin):
    ...
    ordering = ('student__student_id',)  # Ensure consistent ordering
